...
//        (adView.bodyView as? UILabel)?.textColor = .secondaryText
        (adView.bodyView as? UILabel)?.textColor = .whiteColour
        (adView.callToActionView as? UIButton)?.backgroundColor = hexStringToUIColor(hex: addButtonColor ?? "#000000")
